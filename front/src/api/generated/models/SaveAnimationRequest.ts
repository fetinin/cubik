...
export function SaveAnimationRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): SaveAnimationRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function SaveAnimationRequestToJSONTyped(value?: SaveAnimationRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
