...
export function SavedAnimationFromJSONTyped(json: any, ignoreDiscriminator: boolean): SavedAnimation {
    if (json == null) {
        return json;
    }
    return {
...
export function SavedAnimationToJSONTyped(value?: SavedAnimation | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
