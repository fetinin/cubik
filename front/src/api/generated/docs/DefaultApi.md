...
| ------------------------------------------------------------- | ----------------------------------- | ---------------------------------- |
| [**deleteAnimation**](DefaultApi.md#deleteanimation)          | **DELETE** /animation/{id}          | Delete a saved animation           |
| [**getAnimation**](DefaultApi.md#getanimation)                | **GET** /animation/{id}             | Get a specific saved animation     |
| [**getDevices**](DefaultApi.md#getdevices)                    | **GET** /api/devices                | Discover Yeelight CubeLite devices |
| [**listAnimations**](DefaultApi.md#listanimations)            | **GET** /animation/list/{device_id} | List saved animations for a device |
| [**saveAnimation**](DefaultApi.md#saveanimationoperation)     | **POST** /animation/save            | Save animation to database         |
...
| [**updateAnimation**](DefaultApi.md#updateanimationoperation) | **PUT** /animation/{id}             | Update an existing saved animation |
