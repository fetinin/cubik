...
export class DefaultApi extends runtime.BaseAPI {
     ...
     */
    async deleteAnimationRaw(requestParameters: DeleteAnimationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DeleteAnimationResponse>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => DeleteAnimationResponseFromJSON(jsonValue));
    }
     ...
     * Delete a saved animation
     */
    async deleteAnimation(requestParameters: DeleteAnimationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DeleteAnimationResponse> {
     ...
     */
    async getAnimationRaw(requestParameters: GetAnimationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetAnimationResponse>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => GetAnimationResponseFromJSON(jsonValue));
    }
     ...
     * Get a specific saved animation
     */
    async getAnimation(requestParameters: GetAnimationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetAnimationResponse> {
     ...
     */
    async listAnimationsRaw(requestParameters: ListAnimationsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ListAnimationsResponse>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ListAnimationsResponseFromJSON(jsonValue));
    }
     ...
     * List saved animations for a device
     */
    async listAnimations(requestParameters: ListAnimationsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ListAnimationsResponse> {
     ...
     */
    async saveAnimationRaw(requestParameters: SaveAnimationOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SaveAnimationResponse>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => SaveAnimationResponseFromJSON(jsonValue));
    }
     ...
     * Save animation to database
     */
    async saveAnimation(requestParameters: SaveAnimationOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SaveAnimationResponse> {
     ...
     */
    async updateAnimationRaw(requestParameters: UpdateAnimationOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<UpdateAnimationResponse>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => UpdateAnimationResponseFromJSON(jsonValue));
    }
     ...
     * Update an existing saved animation
     */
    async updateAnimation(requestParameters: UpdateAnimationOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<UpdateAnimationResponse> {
